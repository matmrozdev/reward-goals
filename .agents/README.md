...
| Mobile | Testing       | [Maestro E2E tests](rules/mobile/testing/maestro-e2e.md)           | Define mobile E2E structure, selectors, test data, critical-flow coverage, failure diagnosis, and validation.         |
