...
4. Run checks proportionate to the change. Stage explicit paths, inspect the
   staged diff, and create a compliant commit. Do not amend existing commits
...
8. Report the branch, commit, validation, and pull request URL.
